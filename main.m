...
[P_POD(1),P_FAR(1),P_CSI(1),T_POND(1)] = contingency_table( perssian_des_2010, IMD_des_2010 );
 
%2011
[T_POD(2),T_FAR(2),T_CSI(2),T_POND(2)] = contingency_table( TRMM_des_2011, IMD_des_2011 );
[P_POD(2),P_FAR(2),P_CSI(2),T_POND(2)] = contingency_table( perssian_des_2011, IMD_des_2011 );
 
%2012
[T_POD(3),T_FAR(3),T_CSI(3),T_POND(3)] = contingency_table( TRMM_des_2012, IMD_des_2012 );
[P_POD(3),P_FAR(3),P_CSI(3),T_POND(3)] = contingency_table( perssian_des_2012, IMD_des_2012 );
 
%2013
[T_POD(4),T_FAR(4),T_CSI(4),T_POND(4)] = contingency_table( TRMM_des_2013, IMD_des_2013 );
[P_POD(4),P_FAR(4),P_CSI(4),T_POND(4)] = contingency_table( perssian_des_2013, IMD_des_2013 );
 
%2014
[T_POD(5),T_FAR(5),T_CSI(5),T_POND(5)] = contingency_table( TRMM_des_2014, IMD_des_2014 );
[P_POD(5),P_FAR(5),P_CSI(5),T_POND(5)] = contingency_table( perssian_des_2014, IMD_des_2014 );
 
%2015
[T_POD(6),T_FAR(6),T_CSI(6),T_POND(6)] = contingency_table( TRMM_des_2015, IMD_des_2015 );
[P_POD(6),P_FAR(6),P_CSI(6),T_POND(6)] = contingency_table( perssian_des_2015, IMD_des_2015 );
 
%2016
[T_POD(7),T_FAR(7),T_CSI(7),T_POND(7)] = contingency_table( TRMM_des_2016, IMD_des_2016 );
[P_POD(7),P_FAR(7),P_CSI(7),T_POND(7)] = contingency_table( perssian_des_2016, IMD_des_2016 );
 
%2017
[T_POD(8),T_FAR(8),T_CSI(8),T_POND(8)] = contingency_table( TRMM_des_2017, IMD_des_2017 );
[P_POD(8),P_FAR(8),P_CSI(8),T_POND(8)] = contingency_table( perssian_des_2017, IMD_des_2017 );
 
%2018
[T_POD(9),T_FAR(9),T_CSI(9),T_POND(9)] = contingency_table( TRMM_des_2018, IMD_des_2018 );
[P_POD(9),P_FAR(9),P_CSI(9),T_POND(9)] = contingency_table( perssian_des_2018, IMD_des_2018 );
 
%2019
[T_POD(10),T_FAR(10),T_CSI(10),T_POND(10)] = contingency_table( TRMM_des_2019, IMD_des_2019 );
[P_POD(10),P_FAR(10),P_CSI(10),T_POND(10)] = contingency_table( perssian_des_2019, IMD_des_2019 );
...
%product,gauge :: time series data taken for all days in year 21x21x365  
 ...
 P_CC=[] ;
%2010
[ T_Bias(1), T_RMSE(1), T_CC(1) ] = metrics( TRMM_precip_2010,IMD_precip_2010 );
[ P_Bias(1), P_RMSE(1), P_CC(1) ] = metrics( PER_precip_2010,IMD_precip_2010 );
%2011
[ T_Bias(2), T_RMSE(2), T_CC(2) ] = metrics( TRMM_precip_2011,IMD_precip_2011 );
[ P_Bias(2), P_RMSE(2), P_CC(2) ] = metrics( PER_precip_2011,IMD_precip_2011 );
 
%2012
[ T_Bias(3), T_RMSE(3), T_CC(3) ] = metrics( TRMM_precip_2012,IMD_precip_2012 );
[ P_Bias(3), P_RMSE(3), P_CC(3) ] = metrics( PER_precip_2012,IMD_precip_2012 );
%2013
[ T_Bias(4), T_RMSE(4), T_CC(4) ] = metrics( TRMM_precip_2013,IMD_precip_2013 );
[ P_Bias(4), P_RMSE(4), P_CC(4) ] = metrics( PER_precip_2013,IMD_precip_2013 );
%2014
[ T_Bias(5), T_RMSE(5), T_CC(5) ] = metrics( TRMM_precip_2014,IMD_precip_2014 );
[ P_Bias(5), P_RMSE(5), P_CC(5) ] = metrics( PER_precip_2014,IMD_precip_2014 );
%2015
[ T_Bias(6), T_RMSE(6), T_CC(6) ] = metrics( TRMM_precip_2015,IMD_precip_2015 );
[ P_Bias(6), P_RMSE(6), P_CC(6) ] = metrics( PER_precip_2015,IMD_precip_2015 );
%2016
[ T_Bias(7), T_RMSE(7), T_CC(7) ] = metrics( TRMM_precip_2016,IMD_precip_2016 );
[ P_Bias(7), P_RMSE(7), P_CC(7) ] = metrics( PER_precip_2016,IMD_precip_2016 );
%2017
[ T_Bias(8), T_RMSE(8), T_CC(8) ] = metrics( TRMM_precip_2017,IMD_precip_2017 );
[ P_Bias(8), P_RMSE(8), P_CC(8) ] = metrics( PER_precip_2017,IMD_precip_2017 );
%2018
[ T_Bias(9), T_RMSE(9), T_CC(9) ] = metrics( TRMM_precip_2018,IMD_precip_2018 );
[ P_Bias(9), P_RMSE(9), P_CC(9) ] = metrics( PER_precip_2018,IMD_precip_2018 );
%2019
[ T_Bias(10), T_RMSE(10), T_CC(10) ] = metrics( TRMM_precip_2019,IMD_precip_2019 );
[ P_Bias(10), P_RMSE(10), P_CC(10) ] = metrics( PER_precip_2019,IMD_precip_2019 );


figure,subplot(3,1,1),plot(IMD_precip_2010),title('imd2010');
       subplot(3,1,2),plot(TRMM_precip_2010),title('trmm2010');
       subplot(3,1,3),plot(PER_precip_2010),title('persian2010');
       
figure,subplot(3,1,1),plot(IMD_precip_2011),title('imd2011');
       subplot(3,1,2),plot(TRMM_precip_2011),title('trmm2011');
       subplot(3,1,3),plot(PER_precip_2011),title('persian2011');
figure,subplot(3,1,1),plot(IMD_precip_2012),title('imd2012');
       subplot(3,1,2),plot(TRMM_precip_2012),title('trmm2012');
       subplot(3,1,3),plot(PER_precip_2012),title('persian2012');
figure,subplot(3,1,1),plot(IMD_precip_2013),title('imd2013');
       subplot(3,1,2),plot(TRMM_precip_2013),title('trmm2013');
       subplot(3,1,3),plot(PER_precip_2013),title('persian2013');
       
figure,subplot(3,1,1),plot(IMD_precip_2014),title('imd2014');
       subplot(3,1,2),plot(TRMM_precip_2014),title('trmm2014');
       subplot(3,1,3),plot(PER_precip_2014),title('persian2014');
figure,subplot(3,1,1),plot(IMD_precip_2015),title('imd2015');
       subplot(3,1,2),plot(TRMM_precip_2015),title('trmm2015');
       subplot(3,1,3),plot(PER_precip_2015),title('persian2015');

figure,subplot(3,1,1),plot(IMD_precip_2016),title('imd2016');
       subplot(3,1,2),plot(TRMM_precip_2016),title('trmm2016');
       subplot(3,1,3),plot(PER_precip_2016),title('persian2016');
figure,subplot(3,1,1),plot(IMD_precip_2017),title('imd2017');
       subplot(3,1,2),plot(TRMM_precip_2017),title('trmm2017');
       subplot(3,1,3),plot(PER_precip_2017),title('persian2017');
       
figure,subplot(3,1,1),plot(IMD_precip_2018),title('imd2018');
       subplot(3,1,2),plot(TRMM_precip_2018),title('trmm2018');
       subplot(3,1,3),plot(PER_precip_2018),title('persian2018');
figure,subplot(3,1,1),plot(IMD_precip_2019),title('imd2019');
       subplot(3,1,2),plot(TRMM_precip_2019),title('trmm2019');
       subplot(3,1,3),plot(PER_precip_2019),title('persian2019');